...
\usepackage{subfig}          % Bilderformatierung mehrere nebeneinander und so
...
\begin{figure*}[t!]
  \centering
  \subfloat[Bezeichnung der linken Grafik]{\includegraphics[width=0.32\textwidth]{../Messung/BaK.jpg }} % \caption{\label{fig:BaK} \textsuperscript{133}Ba}
  \subfloat[Bezeichnung der linken Grafik]{\includegraphics[width=0.32\textwidth]{../Messung/BaK.jpg }} % \caption{\label{fig:NaK} \textsuperscript{22}Na}
  \subfloat[Bezeichnung der linken Grafik]{\includegraphics[width=0.32\textwidth]{../Messung/BaK.jpg }} % \caption{\label{fig:CsK} \textsuperscript{137}Cs}
\end{figure*}
