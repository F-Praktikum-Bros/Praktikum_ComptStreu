...
\bibitem{jdosis}Bundesamt für Strahlenschutz, URL: bfs.de/DE/themen/ion/umwelt/natuerliche-strahlenbelastung/natuerliche-strahlenbelastung_node.html
\bibitem{q4}Autor, Titel, Verlag,  [1945]
\end{thebibliography}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{OsziVerstaerkerkurve/TEK00009.jpeg}
  \caption{\label{fig:aufbau} Versuchsaufbau aus \cite{skript07}.}
\end{figure}
